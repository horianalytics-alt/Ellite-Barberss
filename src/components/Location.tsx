...
export function Location() {
  ...
  const fallbackDirectionsUrl = googleMapsUrl || `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(address)}`;
  const mapsEmbed =
    googleMapsEmbedUrl ||
  ...
  // Split hoursText by newline for multiple schedule lines
  const hourLines = hoursText
            ...
            <div className="p-8 rounded-3xl bg-[#141414] border border-[#C9A84C]/30 shadow-xl space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  {addressComplement && (
                    <span className="inline-block mt-1 text-xs text-[#E0C068] font-medium">
                      {addressComplement}
                    </span>
                  )}
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-serif text-lg font-bold text-white mb-1.5">Horário de Atendimento</h3>
                  <div className="space-y-1">
                    {hourLines.map((line, idx) => (
                      <p key={idx} className="text-sm font-semibold text-[#E0C068]">
                        {line}
                      </p>
                    ))}
                  </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    WhatsApp: {phoneText || "(11) 93470-6817"}
                  </p>
                </div>
              </div>
            </div>
