...
export function Location({ whatsappUrl }: LocationProps) {
  const address = "Rua Prudente de Moraes, N10, loja de frente, Arujá - SP";
  const mapsEmbedUrl =
