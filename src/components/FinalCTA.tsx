...
export function FinalCTA({ booksyUrl }: FinalCTAProps) {
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-r from-[#C9A84C] via-[#E5C875] to-[#B8963B] text-black">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-black/10 backdrop-blur-sm border border-black/15 mb-6">
          <Sparkles className="w-4 h-4 text-black" />
          <span className="text-xs font-bold uppercase tracking-[0.25em] text-black">
            Seu Momento de Cuidado & Estilo
          </span>
        </div>
