...
export function Header({ booksyUrl }: HeaderProps) {
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 rounded-full border border-[#C9A84C] flex items-center justify-center bg-black/60 shadow-[0_0_15px_rgba(201,168,76,0.25)] group-hover:border-[#E0C068]">
              <Scissors className="w-5 h-5 text-[#C9A84C] group-hover:rotate-12 transition-transform duration-300" />
            </div>
            <div className="flex flex-col">
              <span className="font-serif text-lg sm:text-xl font-bold tracking-[0.2em] text-white group-hover:text-gold-gradient uppercase">
                Ellite Barberss
              </span>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            >
              <span className="absolute inset-0 bg-gradient-to-r from-[#8C7126] via-[#C9A84C] to-[#E0C068] group-hover:opacity-100 transition-opacity"></span>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="pt-4">
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setMobileMenuOpen(false)}
                className="w-full flex items-center justify-center gap-2 py-3 rounded-lg bg-gradient-to-r from-[#C9A84C] to-[#E0C068] text-black font-semibold text-sm uppercase tracking-wider shadow-lg shadow-[#C9A84C]/20"
              >
                <Calendar className="w-4 h-4" />
